...
function PhotoSample({ alt }: { alt: string }) {
  return (
    ...
    >
      ...
      />
      <span className="absolute bottom-[.5rem] right-6 size-0 origin-bottom-left -rotate-90 overflow-visible whitespace-nowrap text-sm !text-white opacity-80 shadow-md drop-shadow-md">
        kachkaev.ru/photos
      </span>
